# Invalid edge placements
execute if items entity @s container.8 *[custom_data~{unt-1.multi_slot:1b}] run return run function unt-1:inventory/return-item {slot:8}
execute if items entity @s container.17 *[custom_data~{unt-1.multi_slot:1b}] run return run function unt-1:inventory/return-item {slot:17}
execute if items entity @s container.26 *[custom_data~{unt-1.multi_slot:1b}] run return run function unt-1:inventory/return-item {slot:26}
execute if items entity @s container.35 *[custom_data~{unt-1.multi_slot:1b}] run return run function unt-1:inventory/return-item {slot:35}

# Bottom row - items that block downward can't be placed here
...
# Check for overlapping: diagonal blocker (+10) and right blocker (+1) both blocking same slot
